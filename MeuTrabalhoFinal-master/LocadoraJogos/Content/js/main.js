...
(function ($) {
   ...
   ===========================================================*/
    ...
    $('.btn-num-product-down').on('click', function (e) {
        ...
        var qtd = $(this).parent().parent().parent().find(".qtdProduto");
        if (numProduct > 1) $(this).next().val(numProduct - 1);
        var quantidade = qtd.val();

        var precoProduto = $(this).parent().parent().parent().find(".precoProduto").text().replace(",", ".");
    ...
    function atualizaTotal() {
        var total = 0;
        var precos = document.querySelectorAll(".subtotalProduto");
